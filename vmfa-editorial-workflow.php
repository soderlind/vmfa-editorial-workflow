...
// Plugin constants.
define( 'VMFA_EDITORIAL_WORKFLOW_VERSION', '1.2.0' );
...
/**
 * Check if Rules Engine add-on is active.
 *
 * @return bool True if Rules Engine is available.
 */
function has_rules_engine(): bool {
	return defined( 'VMFA_RULES_ENGINE_VERSION' );
}
